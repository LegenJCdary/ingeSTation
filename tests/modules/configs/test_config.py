...
from ingestation_test.data.configs import validate_json_passed, validate_json_failed, \
    error_messages as err_msg, merge_conf, config_rule
...
class TestMergedConf:
    ...
    @pytest.mark.parametrize("dct, expect", [
        [merge_conf.dct_nested, merge_conf.expect_nested],
        [merge_conf.dct_nested_with_list_value, merge_conf.expect_nested_with_list_value],
        [merge_conf.dct_complete_config, merge_conf.expect_complete_config],
    ])
